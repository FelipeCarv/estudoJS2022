...
const nome = getCatInfo().name;
const cor = getCatInfo().color;
const idade = getCatInfo().age;

console.log(`${nome} é um gato ${cor} de ${idade} anos.`);
...
const tituloSecundario = document.querySelectorAll('.secondary-title');
