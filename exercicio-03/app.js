...
const foodsInfo = 'Até aqui, o  array \"brazilianFoods\" possui ' + brazilianFoods.push() + ' itens: '+ brazilianFoods[0] +', '+ brazilianFoods[1] +' e '+ brazilianFoods[0];
...
const femaleDogNames = ['Leona', 'Diana', 'Sora'];

const dogNames = femaleDogNames.concat(maleDogNames);
