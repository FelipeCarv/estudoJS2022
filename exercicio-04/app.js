...
const series = ['LOTR', 'GOT', 'Sandman'];
const sentence = `Minhas 3 séries favoritas são: ${series.join(', ')}.`
;
...
const randomShow = series;

// console.log(randomShow.includes(randomTVShow));
...
const tipoSentence = `O tipo de dado que a const isRandomTVShowIncluded" armazena é: ${typeof series}`;
// console.log(tipoSentence);
...
/*
  ...
  caracteres? BOOLEAN."
*/
// console.log(`A string que a "typeSentence" armazena tem mais de 39 caracteres? ${String(series.length) > 39}.`)
...
const isNotAString = (typeof randomShow === String);
